    ...
    pane.innerHTML = `
      ...
      <div class="saved-layout">
        <section class="panel saved-browser"><div class="saved-browser-head"><div><span class="saved-section-label">Library</span><h3>Saved templates</h3></div><span class="saved-browser-count" id="savedBrowserCount">0 items</span></div>
          <div class="saved-toolbar"><label class="saved-search-wrap">${icon("search")}<input type="search" id="savedSearch" placeholder="Search saved prompts" autocomplete="off"></label><select id="savedModeFilter"><option value="all">All modes</option><option value="creative">Creative</option><option value="outfit_catalog">Outfit Catalog</option><option value="reference_product_catalog">Product Catalog</option><option value="reference_product_poster">Product Poster</option><option value="architectural_render">Architectural Render</option><option value="architectural_sketch">Architectural Concept</option></select></div>
