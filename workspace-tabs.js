(function () {
    ...
    function loadWorkspaceAssets() {
        ...
        loadScript("architectural-taxonomy.js?v=4.5-style-semantic-1", "architectural-taxonomy-script");
        loadStyle("architectural-render.css?v=4.5-arch-taxonomy-1", "architectural-render-style");
        loadScript("architecture-prompt-quality.js?v=4.5-composer-compact-1", "architecture-prompt-quality-script");
        ...
        loadScript("architectural-sketch-mode.js?v=4.5-composer-compact-1", "architectural-sketch-mode-script");
