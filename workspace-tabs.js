(function () {
    ...
    function loadWorkspaceAssets() {
        ...
        loadScript("architectural-sketch-builder.js?v=4.5-sketch-text-guard-2", "architectural-sketch-builder-script");
        loadScript("architectural-sketch-mode.js?v=4.5-sketch-text-guard-2", "architectural-sketch-mode-script");
