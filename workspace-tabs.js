(function () {
    ...
    function loadWorkspaceAssets() {
        ...
        loadStyle("architectural-sketch.css?v=4.5-paper-surface-2", "architectural-sketch-style");
        loadScript("architectural-sketch-builder.js?v=4.5-paper-surface-2", "architectural-sketch-builder-script");
        loadScript("architectural-sketch-mode.js?v=4.5-paper-surface-2", "architectural-sketch-mode-script");
