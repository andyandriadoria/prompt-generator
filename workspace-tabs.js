(function () {
    ...
    function loadWorkspaceAssets() {
        ...
        loadStyle("workstation-v2.css?v=4.5-workstation-assets-3", "workstation-v2-style");
        loadScript("workstation-v2.js?v=4.5-workstation-assets-3", "workstation-v2-script");
    }
