(function () {
    ...
    function loadWorkspaceAssets() {
        ...
        loadScript("architectural-render-mode.js?v=4.5-arch-options-1", "architectural-render-mode-script");
        loadStyle("architectural-sketch.css?v=4.5-arch-sketch-5", "architectural-sketch-style");
        loadScript("architectural-sketch-builder.js?v=4.5-arch-sketch-options-1", "architectural-sketch-builder-script");
        loadScript("architectural-sketch-mode.js?v=4.5-arch-sketch-options-1", "architectural-sketch-mode-script");
